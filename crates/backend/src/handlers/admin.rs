...
pub async fn create_org(
    ...
    if orgs.iter().any(|o| o.username == payload.username) {
        return (StatusCode::CONFLICT, Json(Organization { id: 0, username: "".to_string(), description: None, avatar_url: None, website: None, location: None, email: None, visibility: None }));
    }
