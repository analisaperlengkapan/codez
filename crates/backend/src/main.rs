...
fn app() -> Router {
    ...
    Router::new()
        ...
        .route("/api/v1/repos/:owner/:repo/topics", get(list_topics).put(update_topics_misc))
        .route("/api/v1/repos/:owner/:repo/star", post(star_repo_misc))
        .route("/api/v1/repos/:owner/:repo/watch", post(watch_repo_misc))
        .route("/api/v1/repos/:owner/:repo/fork", post(fork_repo_misc))
        .route("/api/v1/repos/search", get(search_repos_misc))
        .route("/api/v1/repos/:owner/:repo/wiki/pages", post(create_wiki_page_misc))
        .route("/api/v1/repos/:owner/:repo/settings", get(get_repo_settings_misc).patch(update_repo_settings_misc))
        ...
        .route("/api/v1/repos/:owner/:repo/secrets", get(list_secrets).post(create_secret_misc))
        .route("/api/v1/repos/:owner/:repo/keys", get(list_deploy_keys).post(create_deploy_key_misc))
        ...
        .route("/api/v1/repos/:owner/:repo/mirror-sync", post(mirror_sync_misc))
        ...
        .route("/api/v1/repos/:owner/:repo/issues/comments/:id/reactions", post(add_reaction_misc))
        .route("/api/v1/repos/:owner/:repo/commits/:sha/diff", get(get_commit_diff))
        .route("/api/v1/repos/:owner/:repo/raw/*path", get(get_raw_file_misc))
        ...
        .route("/api/v1/repos/migrate", post(migrate_repo_misc))
        .route("/api/v1/repos/:owner/:repo/transfer", post(transfer_repo_misc))
        ...
        .route("/api/v1/repos/:owner/:repo/issues/:index/labels", post(add_issue_label_misc))
        .route("/api/v1/repos/:owner/:repo/issues/:index/labels/:id", delete(remove_issue_label_misc))
        .route("/api/v1/repos/:owner/:repo/search", get(search_repo_code_misc))
        .route("/api/v1/packages/:owner/:type/:name/:version", get(get_package_detail))
        .route("/api/v1/repos/:owner/:repo/wiki/pages/:page_name", get(get_wiki_page_misc).put(update_wiki_page_misc))
...
mod tests {
    ...
    use shared::{CreateRepoOption, Repository};
