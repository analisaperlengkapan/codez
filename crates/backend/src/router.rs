...
use shared::{
    Activity, Collaborator, Comment, Commit, DeployKey, Discussion, DiscussionComment, Issue,
    Label, LfsLock, Milestone, Notification, OrgMember, Organization, Package, Project,
    ProjectCard, ProjectColumn, PublicKey, PullRequest, Release, Repository, Review, Secret, Team,
    Topic, User, Webhook, WebhookDelivery, WorkflowRun,
};
...
pub fn api_router() -> Router {
    ...
    Router::new()
        ...
        .route(
            "/api/v1/repos/:owner/:repo/secrets/:name",
        ...
        .route(
            ...
            post(add_org_member).delete(remove_org_member),
        )
